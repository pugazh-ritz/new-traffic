...
def tick_light_cycle():
    ...
    green_sec  = override_green_sec  if override_green_sec  is not None else GREEN_HOLD_SEC
    yellow_sec = override_yellow_sec if override_yellow_sec is not None else YELLOW_HOLD_SEC
...
def on_mode(data):
    ...
    if current_mode == 'GREEN_WAVE' and SIGNAL_ID == 'A':
        _transition('GREEN')
