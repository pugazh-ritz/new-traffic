...
const SignalLogic = ({ signal, currentStrategy }) => {
...
const SignalCard = ({ signal, currentStrategy }) => {
  if (!signal) {
    return (
  ...
  return (
    <div className={`signal-card ${!isOnline ? 'signal-card-offline' : ''} signal-state-${currentState.toLowerCase()}`}>
        ...
        {signal.adaptiveGreenTime && (
          <div className="signal-metric adaptive-timing">
            ...
            <div className="metric-info">
              ...
              <div className="metric-value adaptive-green">{signal.adaptiveGreenTime}s</div>
            </div>
          </div>
        )}
      </div>
      ...
      <SignalLogic signal={signal} currentStrategy={currentStrategy} />
